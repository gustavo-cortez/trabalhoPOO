...
public class InicializacaoDados {
    public static void inicializarTarifas(FunTarifasVisual tarifasIns) {
        ...
        tarifasIns.cadastrarTarifaMensal(LocalDate.of(2024, 1, 1), 200.0);
        tarifasIns.cadastrarTarifaMensal(LocalDate.of(2025, 1, 1), 200.0);
    }

    public static void inicializarVagas(FunVagasVisual vagasIns) {
        // Adicionando vagas
    ...
    public static void inicializarClientes(FunClienteVisual clientesIns) {
    ...
    public static void inicializarVeiculos(FunClienteVisual clienteIns) {
